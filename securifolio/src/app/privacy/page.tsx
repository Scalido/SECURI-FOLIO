    ...
    <div className="min-h-screen pt-24 pb-16 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-invert prose-slate max-w-none prose-headings:font-display prose-headings:text-brand-text prose-a:text-brand-primary hover:prose-a:text-brand-accent space-y-8">
          ...
          <section className="bg-brand-surface/50 border border-brand-border/50 p-8 rounded-2xl">
            <h2 className="text-xl font-bold text-brand-text mb-4">2. Données Collectées</h2>
          ...
          <section className="bg-brand-surface/50 border border-brand-border/50 p-8 rounded-2xl">
            <h2 className="text-xl font-bold text-brand-text mb-4">3. Utilisation des Données</h2>
          ...
          <section className="bg-brand-surface/50 border border-brand-border/50 p-8 rounded-2xl">
            <h2 className="text-xl font-bold text-brand-text mb-4">4. Sécurité et Protection</h2>
            <p className="text-brand-text leading-relaxed">
          ...
          <section className="bg-brand-surface/50 border border-brand-border/50 p-8 rounded-2xl">
            <h2 className="text-xl font-bold text-brand-text mb-4">5. Partage des Données</h2>
            <p className="text-brand-text leading-relaxed">
          ...
          <section className="bg-brand-surface/50 border border-brand-border/50 p-8 rounded-2xl">
            <h2 className="text-xl font-bold text-brand-text mb-4">6. Vos Droits</h2>
            <p className="text-brand-text leading-relaxed">
