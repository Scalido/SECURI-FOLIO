      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-invert prose-slate max-w-none prose-headings:font-display prose-headings:text-brand-text prose-a:text-brand-primary hover:prose-a:text-brand-accent space-y-8">
          <section className="bg-brand-surface/50 border border-brand-border/50 p-8 rounded-2xl">
            <h2 className="text-xl font-bold text-brand-text mb-4">1. Objet</h2>
          ...
          <section className="bg-brand-surface/50 border border-brand-border/50 p-8 rounded-2xl">
            <h2 className="text-xl font-bold text-brand-text mb-4">2. Accès aux Services</h2>
            <p className="text-brand-text leading-relaxed">
          ...
          <section className="bg-brand-surface/50 border border-brand-border/50 p-8 rounded-2xl">
            <h2 className="text-xl font-bold text-brand-text mb-4">3. Responsabilités de l'Utilisateur</h2>
          ...
          <section className="bg-brand-surface/50 border border-brand-border/50 p-8 rounded-2xl">
            <h2 className="text-xl font-bold text-brand-text mb-4">4. Limitations liées à l'IA (Foncier-Édu)</h2>
            <p className="text-brand-text leading-relaxed">
          ...
          <section className="bg-brand-surface/50 border border-brand-border/50 p-8 rounded-2xl">
            <h2 className="text-xl font-bold text-brand-text mb-4">5. Propriété Intellectuelle</h2>
            <p className="text-brand-text leading-relaxed">
          ...
          <section className="bg-brand-surface/50 border border-brand-border/50 p-8 rounded-2xl">
            <h2 className="text-xl font-bold text-brand-text mb-4">6. Modification des Conditions</h2>
            <p className="text-brand-text leading-relaxed">
